...
// 
#if defined(HAS_40PINS) //Added GPIO bindings for Raspberry 1B (only 26 I/O ports) A.Buch 02 Jan. 2020
enum PIGPIO
{
...
#else
//Added GPIO bindings for Raspberry 1B (only 26 I/O ports) A.Buch 02 Jan. 2020
enum PIGPIO
{
	// Original Non-split lines
	PIGPIO_ATN = 2,			// 3
...
#if not defined(EXPERIMENTALZERO) 				// || defined(RASPPI) //added sound for Raspberry 1 A.Buch
